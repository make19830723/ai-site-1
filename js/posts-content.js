...
<h2>结语</h2>
<p>简历的本质是<strong>一份营销文案，产品是你自己</strong>。AI 帮你把"做过什么"翻译成"创造了什么价值"，让 HR 在 6 秒内 get 到你的核心竞争力。</p>
`,
    en: `
...
`
  ...
  "ai-ad-copy-that-converts": {
    zh: `
<h2>广告文案：注意力战争的核心武器</h2>
<p>用户每天接触上千条广告，能记住的不到 1%。你的广告要在 1 秒内抓住眼球、3 秒内传递利益、10 秒内促成行动。<strong>这不是文采比拼，是行为心理学博弈</strong>。AI 能帮你套用经过百年验证的文案公式，把转化率提升一个量级。本文讲透 5 个高转化广告公式。</p>

<h2>公式一：AIDA（注意力-兴趣-欲望-行动）</h2>
<p>最经典的文案公式。<strong>Attention</strong>（标题抓眼球）→ <strong>Interest</strong>（首段讲痛点）→ <strong>Desire</strong>（中段证明利益）→ <strong>Action</strong>（结尾明确 CTA）。提示词："<strong>用 AIDA 公式为【产品】写一条信息流广告，每个环节标注清楚，CTA 要具体可点击</strong>"。</p>
...
<p>对比型文案的利器。<strong>Before</strong>（使用前的糟糕现状）→ <strong>After</strong>（使用后的美好状态）→ <strong>Bridge</strong>（产品就是那座桥）。BAB 通过强烈的"前后对比"激发购买欲，适合美妆、家居、效率工具类产品。</p>
...
<ul>
  ...
  <li><strong>详情页广告</strong>：长文案，FAB 全展开</li>
</ul>

<h2>高转化广告文案提示词</h2>
<blockquote>你是顶级文案。为【产品】写【广告位】广告。目标用户：【画像】。核心卖点：【列表】。要求：1）用 AIDA/PAS/BAB 中最适合的一个公式；2）前 10 字必须抓眼球；3）加入社会认同或适度紧迫感；4）CTA 具体明确；5）给 3 个标题版本对比。禁虚假承诺。</blockquote>

<h2>结语</h2>
<p>广告文案的本质是<strong>用心理学触发行动</strong>。AI 帮你快速套用经典公式、批量生成可测试的变体。但记住，再好的文案也救不了糟糕的产品——<strong>文案放大价值，产品决定成败</strong>。</p>
`,
    en: `
...
<p>如果追求速度，可用<strong>一站式 AI 海报工具</strong>：Canva AI、稿定设计、美图设计室。输入主题和文案，自动生成多套排版方案，可直接下载印刷。优势是快、有模板；劣势是创意同质化。适合时间紧、要求不高的场景。</p>
...
<blockquote>角色表情包的爆款公式：独特造型 + 夸张表情 + 共鸣场景 + 金句文案。</blockquote>
...
<p>字节出品的剪映是国内短视频剪辑的事实标准。<strong>核心 AI 功能</strong>：智能字幕（自动识别语音生成字幕，准确率 95%+）、智能踩点（画面随音乐节拍切换）、文本成片（输入文案自动配画面）、自动抠像（无需绿幕去背景）、AI 提词器。免费且强大，新手首选。</p>
...
<h2>路线三：AI 数字人解说</h2>
<p>另一种高效形式：用<strong> AI 数字人</strong>（HeyGen、D-ID、腾讯智影）做"虚拟讲解员"。输入文案，数字人会口型同步地说出来，配合背景画面。优势是无需真人出镜、可批量生产、多语言版本一键生成。适合知识科普、新闻播报。</p>
...
<h2>法则二：信息的视觉化传达</h2>
<p>封面要让人<strong>1 秒看懂视频主题</strong>。两种做法：一是<strong>大字标题</strong>（封面加 3-5 个字的钩子文案）；二是<strong>具象符号</strong>（讲赚钱画金币，讲减肥画对比身材）。AI 生成时要把核心信息可视化成符号。</p>
...
<ol>
  ...
  <li><strong>人工微调</strong>：改文案、换图、调顺序</li>
...
<ul>
  ...
  <li><strong>营销文案</strong>：本地化优先，重创意而非直译</li>
...
<p>营销需要大量内容——广告文案、社媒帖子、邮件、博客、视频脚本。AI 让内容生产成本降到原来的十分之一。但要<strong>建立内容矩阵</strong>：核心长内容 + 衍生短内容 + 多平台改编。一份素材榨干用尽，触达不同用户。</p>
...
<p>社交媒体运营最累的是<strong>持续输出</strong>——每天要想选题、写文案、配图、排版。一个人维护多个平台更是噩梦。<strong>AI 让社媒内容日更变得可管理</strong>。本文讲解用 AI 规划和批量生产社媒内容。</p>
...
<h2>第四步：批量文案生成</h2>
<p>规划好后，让 AI 批量生成文案："<strong>这是下周 7 个选题【列表】，请按【平台】的格式和风格，分别生成完整文案</strong>"。一次生成一周文案，省去每天写。注意：要给 AI 明确的平台调性（小红书活泼、LinkedIn 专业）。</p>
...
<ul>
  ...
  <li><strong>正文文案</strong>：中等（决定买不买）</li>
...
<blockquote>我要为【产品】投放【平台】广告，目标【转化/点击】。请：1）生成 10 个广告变体（覆盖标题、图、CTA、文案）；2）预测每个的潜力；3）设计 A/B 测试方案（变量、样本、时长）；4）给出测试结果分析框架；5）建议测试优先级。</blockquote>
...
<ul>
  ...
  <li><strong>信息流广告</strong>：测素材、文案、定向</li>
...
<h2>第三步：故事的多渠道改编</h2>
<p>一个核心故事要适配不同渠道。让 AI 改编："<strong>把这个品牌核心故事改编成：1）官网 About 页（500字深度）；2）品牌视频脚本（90秒）；3）社媒系列帖（10条短故事）；4）创始人演讲（5分钟）；5）产品包装文案（50字精华）</strong>"。一个内核，多形态表达。</p>
